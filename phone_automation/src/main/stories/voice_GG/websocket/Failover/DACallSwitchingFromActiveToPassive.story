...
Scenario: Caller client changes its mission
When WS3 chooses mission with name MAN-NIGHT-TACT from available missions named availableMissionIds1 and names missionIdToChange1
...
Scenario: Callee client changes its mission
When WS4 chooses mission with name WEST-EXEC from available missions named availableMissionIds2 and names missionIdToChange2
