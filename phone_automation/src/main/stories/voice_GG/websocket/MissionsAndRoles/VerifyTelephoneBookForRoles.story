...
Scenario: Operator 1 requests all entries from telephone book
...
Scenario: Operator 2 requests all entries from telephone book
...
Scenario: Operator 3 requests all entries from telephone book
