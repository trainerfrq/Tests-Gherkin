...
When WS1 establishes an outgoing phone call with call conditional flag xfr using source callSourceRoleAlias ang target callTargetRoleAlias and names outgoingPhoneCallId2
And waiting for 1 seconds
