Narrative:
As a transferor operator having a transfer call with a transferee operator
I want to cancel transfer while the consultation call with transfer target is on hold
So I can verify that the consultation call is terminated and transfer is canceled
...
Scenario: Transferor puts consultation call on hold
When WS1 puts the phone call with the callId outgoingPhoneCallId2 on hold
And waiting for 2 seconds

Scenario: Transferor retrives the call that waits to be transferred (cancel transfer)
