...
!-- When WS1 loads phone data for mission missionId1 and names roleCallSource and roleCallTarget from the entry number 6
...
When WS1 queries phone data for mission missionId1 in order to call ROLE1 and names them roleCallSource and roleCallTarget
