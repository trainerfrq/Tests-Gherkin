...
When WS2 queries phone data for mission missionId2 in order to call ROLE1(as ROLE2) and names them roleCallSource and roleCallTarget
...
Then WS2 receives call status indication on message buffer named CallStatusIndicationBuffer2 with callId initialOutgoingPhoneCallId and status out_ringing
...
Then WS3 receives call status indication verifying all the messages on message buffer named CallStatusIndicationBuffer3 with callId incomingPhoneCallId2 and status held
