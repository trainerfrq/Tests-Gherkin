...
When SSH host dockerHost2 executes docker stop op-voice-service-${OP_VOICE_PARTITION_KEY_1}-2
When SSH host dockerHost2 executes docker stop op-voice-service-${OP_VOICE_PARTITION_KEY_2}-2
When SSH host dockerHost2 executes docker stop op-voice-service-${OP_VOICE_PARTITION_KEY_3}-2
