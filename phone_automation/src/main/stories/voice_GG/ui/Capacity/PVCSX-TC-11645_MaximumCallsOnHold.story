...
Meta: @TEST_STEP_ACTION: Op1 puts active call on hold
...
Meta: @TEST_STEP_ACTION: Op1 terminates all the remaining waiting calls
...
Meta: @TEST_STEP_ACTION: Op1 calls Op2
...
Meta: @TEST_STEP_ACTION: Op2 answers call
...
Meta: @TEST_STEP_ACTION: Op1 puts call on hold
...
Meta: @TEST_STEP_ACTION: External call source terminates all calls
...
Meta: @TEST_STEP_ACTION: Op1 takes call from hold and terminates call
