...
Meta: @TEST_STEP_ACTION: Op1 clears Call History list
...
Scenario: 2. Set up 16 external DA calls that call Op1
...
Meta: @TEST_STEP_ACTION: Op1 answers all 16 calls
...
Meta: @TEST_STEP_ACTION: Op1 opens Call History list and verifies the number of calls in the list
...
Meta: @TEST_STEP_ACTION: Op1 does a recall for 16 calls in the Call History
@TEST_STEP_REACTION: Only 1 active call is visible, all the time
...
Meta: @TEST_STEP_ACTION: While having 1 active call, Op1 receives a role call
...
Meta: @TEST_STEP_ACTION: Op1 answers role call
...
Meta: @TEST_STEP_ACTION: Op1 calls another role
...
Meta: @TEST_STEP_ACTION: Op2 answers role call
@TEST_STEP_REACTION: Op1 has 1 active call
...
Meta: @TEST_STEP_ACTION: Op1 answers Op3 call
@TEST_STEP_REACTION: Op1 has 1 active call
...
Meta: @TEST_STEP_ACTION: Op1 terminates call
