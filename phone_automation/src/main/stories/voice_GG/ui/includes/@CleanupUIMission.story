...
Then wait for 5 seconds
Then HMI OP1 with layout <<LAYOUT_TWR>> will do a change mission if DISPLAY STATUS section mission has not the default mission <<MISSION_1_NAME>>
...
Then wait for 5 seconds
Then HMI OP2 with layout <<LAYOUT_TWR>> will do a change mission if DISPLAY STATUS section mission has not the default mission <<MISSION_2_NAME>>
...
Then wait for 5 seconds
Then HMI OP3 with layout <<LAYOUT_TWR>> will do a change mission if DISPLAY STATUS section mission has not the default mission <<MISSION_3_NAME>>
