...
Then HMI OP3 does a clean up for function key PHONEBOOK if the state is Active
Then HMI OP3 does a clean up for function key CALLHISTORY if the state is Active
Then HMI OP3 does a clean up for function key MISSIONS if the state is Active
