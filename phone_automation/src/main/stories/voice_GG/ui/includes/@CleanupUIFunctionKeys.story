...
Then HMI OP1 with layout <<LAYOUT_MISSION1>> does a clean up for function key SETTINGS if the state is active
...
Then HMI OP2 with layout <<LAYOUT_MISSION2>> does a clean up for function key SETTINGS if the state is active
...
Then HMI OP3 with layout <<LAYOUT_MISSION3>> does a clean up for function key SETTINGS if the state is active
