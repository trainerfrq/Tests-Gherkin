...
@TEST_CASE_PASS_FAIL_CRITERIA: This test is passed if a call is terminated after activating a no forwarding condition of a Conditional Call Forward rule
