Narrative:
As an operator
I want to initiate an outgoing IA call redialing the previous IA call
So I can check that the IA call is initiated to the destination according to the previous IA call
...
Scenario: OP1 redials last number
