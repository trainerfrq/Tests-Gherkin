Narrative:
As an operator
I want to initiate an outgoing priority DA call redialing the last outgoing priority DA call
So I can check that the priority DA call is initiated to the destination according to the previous DA call
