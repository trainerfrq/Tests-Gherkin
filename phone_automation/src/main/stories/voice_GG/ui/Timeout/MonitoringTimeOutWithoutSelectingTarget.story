...
Scenario: Op1 deactivates Monitoring functionality and verifies the button state
When HMI OP1 with layout <<LAYOUT_MISSION1>> presses function key MONITORING
...
Then HMI OP1 with layout <<LAYOUT_MISSION1>> has timerBar MONITORING in state visible for 29 seconds
