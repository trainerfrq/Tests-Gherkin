...
Then HMI OP1 has the call queue item 2-OP1 in the active list with name label <<OP2_NAME>>
...
Then HMI OP1 has the call queue item 22-OP1 in the active list with name label <<OP2_NAME>>
...
Then HMI OP1 has the call queue item 222-OP1 in the active list with name label <<OP2_NAME>>
...
Then HMI OP1 has the call queue item 2222-OP1 in the active list with name label <<OP2_NAME>>
