...
Scenario: Operator receives an IA call and verifies call queue section (active)
...
Scenario: IA call is terminated
When HMI OP2 presses IA key IA - OP1
Then HMI OP2 has in the call queue a number of 0 calls

Scenario: Operator receives an another priority call and verifies call queue section (priority)
