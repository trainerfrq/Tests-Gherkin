...
Meta:
@TEST_STEP_ACTION: System Technician: Restart trunk-proxy-service on host 1 and OP1 calls legacy external phone after 1 second
...
Then HMI OP1 has the call queue item OP2-LegacyPhone in state out_ringing
...
Scenario: 2. OP1 ends ringing call. Wait until trunk-proxy-service is up and running again
Meta:
@TEST_STEP_ACTION: OP1 ends ringing call. Wait until trunk-proxy-service is up and running again
@TEST_STEP_REACTION: OP1 has no calls.Trunk-proxy-service is up and running again
...
Meta:
@TEST_STEP_ACTION: System Technician: Restart trunk-proxy-service on host 2 and OP1 calls legacy external phone after 1 second
...
Scenario: 4. OP1 ends ringing call. Wait until trunk-proxy-service is up and running again
Meta:
@TEST_STEP_ACTION: OP1 ends ringing call. Wait until trunk-proxy-service is up and running again
@TEST_STEP_REACTION: OP1 has no calls. Trunk-proxy-service is up and running again
...
Meta:
@TEST_STEP_ACTION: System Technician: Restart trunk-location-service on host 1 and OP1 calls legacy external phone after 1 second
...
Scenario: 6. OP1 ends ringing call. Wait until trunk-location-service is up and running again
Meta:
@TEST_STEP_ACTION: OP1 ends ringing call. Wait until trunk-location-service is up and running again
@TEST_STEP_REACTION: Trunk-location-service is up and running again
...
Meta:
@TEST_STEP_ACTION: System Technician: Restart trunk-location-service on host 2 and OP1 calls legacy external phone after 1 second
...
Meta:
@TEST_STEP_ACTION: OP1 ends ringing call.
...
Then HMI OP1 terminates the call queue item OP2-LegacyPhone
