...
Scenario: Verify displayed Timeout bar
Then HMI OP1 verifies that Timeout bar is not visible on call queue item OP3-OP1
Then HMI OP1 verifies that Timeout bar is not visible on DA Key OP3
...
Then HMI OP1 has the call queue item OP3-OP1 in state inc_ringing
Then HMI OP1 has in the call queue the item OP3-OP1 with priority
