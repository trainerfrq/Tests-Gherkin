...
And SSH host dockerHost3 executes FILE_LOG_NAME=${HOSTNAME,,}-$(date +"%Y%m%d_%H%M%S").log && mkdir -p /var/log/opvoice/ && docker logs op-voice03 > /var/log/opvoice/${FILE_LOG_NAME} && gzip /var/log/opvoice/${FILE_LOG_NAME}
