...
ssh $SERVER2 "docker stop op-voice-service-cwp-vst02-14-1"
ssh $SERVER2 "docker stop op-voice-service-cwp-vst02-15-1"
ssh $SERVER2 "docker stop op-voice-service-cwp-vst02-16-1"
...
ssh $SERVER2 "docker start op-voice-service-cwp-vst02-14-1"
ssh $SERVER2 "docker start op-voice-service-cwp-vst02-15-1"
ssh $SERVER2 "docker start op-voice-service-cwp-vst02-16-1"
